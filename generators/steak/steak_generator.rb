class SteakGenerator < Rails::Generator::Base
  ...
  def manifest
    record do |m|
      m.directory 'acceptance/support'
      m.directory 'lib/tasks'
      m.template "acceptance_helper.rb", "acceptance/acceptance_helper.rb"
      m.file "helpers.rb",               "acceptance/support/helpers.rb"
      m.file "paths.rb",                 "acceptance/support/paths.rb"
